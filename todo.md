...
- [x] Set up payment links for single payment option
- [x] Set up payment plans (installments)
- [x] Set up monthly subscription option
- [x] Build Client Portal page
- [x] Create API endpoint for Stripe Customer Portal
- [ ] Integrate Stripe Customer Portal
- [ ] Add free Discovery Session booking
- [ ] Update Services page with payment buttons
- [ ] Integrate Calendly for session booking
- [ ] Test complete payment flow
- [ ] Draft announcement email for clients
- [ ] Publish website to jeffbatton.com
...
- [x] Create Stripe discount codes for legacy clients (LEGACY150, LEGACY125, LEGACY95)
- [x] Add Client Portal link to navigation
